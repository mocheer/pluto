...
//LockWork 锁定计算机
func LockWork() string {
	return Exec(runDll32, dllLockWorkStation)
}

//ControlRunDLL 控制面板
func ControlRunDLL() string {
...
func RegisterService(name string, path string, start string) string {
